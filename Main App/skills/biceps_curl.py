import math
# AGENT SKILL: biceps curl form analysis
...
class BicepsCurlDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        if self.stage == "up":
            # Track worst issue: prioritize swinging, then drift
            if swing_status == "SWINGING":
                self.rep_issue = "SWINGING"
            elif shoulder_status == "ELBOW DRIFTING" and getattr(self, "rep_issue", None) != "SWINGING":
                self.rep_issue = "ELBOW DRIFTING"
