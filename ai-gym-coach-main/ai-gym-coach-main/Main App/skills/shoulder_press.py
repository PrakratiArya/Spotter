# AGENT SKILL: shoulder press form analysis
...
class ShoulderPressDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        if self.stage == "up":
            if back_arch_status in ["Excessive Arch", "Slight Arch"]:
                if self.rep_issue != "Excessive Arch":
                    self.rep_issue = back_arch_status
